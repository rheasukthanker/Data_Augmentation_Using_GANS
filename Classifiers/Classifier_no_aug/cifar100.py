...
model.fit(train_images, train_labels,batch_size=batch_size,callbacks=[early_stopping, mcp_save],class_weight=class_weights,validation_split=0.1, epochs=epochs)
model.load_weights("best.mdl_wts_cifar100_2.hdf5")
test_loss, test_acc,o = model.evaluate(test_images,test_labels,verbose=2)
