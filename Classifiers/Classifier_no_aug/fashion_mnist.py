...
model.fit(train_images, train_labels,batch_size=batch_size,class_weight=class_weights,callbacks=[early_stopping, mcp_save],validation_split=0.1, epochs=epochs)
