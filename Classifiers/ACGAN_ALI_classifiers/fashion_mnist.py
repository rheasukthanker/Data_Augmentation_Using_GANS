...
parser.add_argument('--model_name', nargs="?", type=str, default='../../data/ACGAN_ALI_pretrained/V1/acgan_ali_v1_generator_fashion_mnist.h5', help='model_name')
...
weights=[]
for i in range(len(classes_to_sparsify)):
    [X,labels]=get_images_from_generator(classes_to_sparsify[i],model_name,int((1-sparsify_percentage[i])*6000),latent_dim)
