...
parser.add_argument('--model_name', nargs="?", type=str, default='../../data/ACGAN_ALI_pretrained/V1/acgan_ali_v1_generator_med.h5', help='model_name')
...
mcp_save = tf.keras.callbacks.ModelCheckpoint('best.mdl_wts_med4.hdf5', save_best_only=True, monitor='val_loss', mode='min')
...
i=1
[X,labels]=get_images_from_generator(i,model_name,num_negatives-num_positives,latent_dim)
