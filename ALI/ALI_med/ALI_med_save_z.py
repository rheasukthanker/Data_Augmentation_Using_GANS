...
while (i+batch_size)<x_train.shape[0]:
      ...
      z_train.append(reconstruct_img(x_train[start_index:end_index,:,:,:],y_train[start_index:end_index],zgen))
      i=end_index
z_train.append(reconstruct_img(x_train[i:x_train.shape[0],:,:,:],y_train[i:x_train.shape[0]],zgen))
