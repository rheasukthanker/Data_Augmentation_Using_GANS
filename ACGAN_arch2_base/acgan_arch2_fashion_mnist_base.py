#ACGAN on fashion MNIST with generator architecture same as generator of BiGAN and discriminator similar to discriminator of BiGAN 
import numpy as np
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=300, n_batch=64):
	...
	for i in range(n_epochs):
		...
		if ((i+1)%2)==0:
		 g_model.save('acgan_generator_arch2_fashion_mnist_epoch'+str(i+1)+'.h5') # model saved every second epoch
