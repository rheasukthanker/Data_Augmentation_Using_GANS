# Modified Auxiliary Classifier gan (ac-gan) on medical dataset with 25% real data and 75% fake data
import numpy as np
import pickle
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=300, n_batch=64):
	...
	for i in range(n_epochs):
		...
		if ((i+1)%2)==0:
			g_model.save('acgan_generator_sampling_25_75_med_epoch'+str(i+1)+'.h5') #save model every second epoch
