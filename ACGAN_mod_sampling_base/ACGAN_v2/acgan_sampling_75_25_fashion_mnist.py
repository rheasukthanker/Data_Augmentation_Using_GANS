# Modified Auxiliary Classifier gan (ac-gan) on fashion mnsit with 75% real data and 25% fake data
import numpy as np
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=300, n_batch=64):
	...
	for i in range(n_epochs):
		...
		if ((i+1)%2)==0:
			g_model.save('acgan_generator_sampling_75_25_fashion_mnist_epoch'+str(i+1)+'.h5') #model saved every second epoch
