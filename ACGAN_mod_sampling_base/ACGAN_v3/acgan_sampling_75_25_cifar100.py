# Modified Auxiliary Classifier gan (ac-gan) on CIFAR100 with 75% real data and 25% fake data
import numpy as np
...
def train(g_model,
    ...
    for i in range(n_epochs):
        for j in range(bat_per_epo):
            ...
            [X_real, labels_real
             ], y_real = generate_real_samples(dataset, 3 * quarter_batch)
        ...
        if ((i + 1) % 2) == 0:
            g_model.save('acgan_generator_sampling_75_25_cifar100_epoch' +
